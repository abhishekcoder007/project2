...
export default function AlertDialog1() {
  ...
  let vx=/^[A-Za-z][A-Za-z0-9_]{7,29}$/

  function Userd(e) {
      let name = e.target.value;
      if (name.length<3) {
          seterror(true);
      } else if(!name.match(vx)){
           ...
           <div> <Main/></div> */}
            ...
            <form onSubmit={handlesubmit}>
                <div class="container">
                    ...
                    <button type="button" class="cancelbtn"><Link to="/Back" style={{ color: "white", fontSize: '15px', fontWeight: 'bold', textDecoration: 'none' }}>Go Back</Link></button>
